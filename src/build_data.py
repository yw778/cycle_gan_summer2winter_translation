...
tf.flags.DEFINE_string('X_input_dir', 'data/norway_rail/trainA',
                       'X input directory, default: data/norway_rail/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/norway_rail/trainB',
                       'Y input directory, default: data/norway_rail/trainB')
