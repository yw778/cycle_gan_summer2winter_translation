...
class CycleGAN:
  def __init__(self,
    ...
    Args:
      ...
      segemenentation: segmentation filter for fine grained transform
    """
    ...
    # segemetation staff yw3025
    # self.segmentation = segmentation
    # self.graph = graph
    # self.sess = tf.Session()
    # self.coord = tf.train.Coordinator()
    # threads = tf.train.start_queue_runners(sess=self.sess, coord=self.coord, start=True)
    ...
    # discriminator hint staff yw3025 define mask
  ...
  def model(self):
    ...
    # discriminator hint staff yw3025 call loss function
