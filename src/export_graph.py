...
tf.flags.DEFINE_string('XtoY_model', 'summer2winter.pb', 'XtoY model name, default: summer2winter.pb')
tf.flags.DEFINE_string('YtoX_model', 'winter2summer.pb', 'YtoX model name, default: winter2summer.pb')
